...
double_scp wieseman@tha310.mpp.mpg.de mwiese@mppui4.t2.rzg.mpg.de /ptmp/mpp/mwiese/NEW-POWHEG-BOX-RES/MiNNLO_res_ptj/bblnuJ/run_Wp_first_MiNNLO_reweight_2loop/combined-*MiN*LO-kQ*-???.top ./tmp/

mv tmp/combined-*MiN*LO-kQ05*-???.top run_Wp_nf6_kQ05/

mv tmp/combined-*MiN*LO-kQ025*-???.top run_Wp_nf6_kQ025/

mv tmp/combined-*MiN*LO-kQ1*-???.top run_Wp_nf6_kQ1/
